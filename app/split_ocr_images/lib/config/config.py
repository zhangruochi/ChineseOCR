...
tf.app.flags.DEFINE_integer('batch_size', 50, "Network batch size during training")
tf.app.flags.DEFINE_integer('max_iters', 1000, "Max iteration")
tf.app.flags.DEFINE_integer('step_size', 1000, "Step size for reducing the learning rate, currently only support one step")
